...
function mapWorkerRoleToCategory(
  role: WorkerDetailsView["workerRole"],
): JobCategory {
...
): UpdateWorkerPayload["workerRole"] {
...
function mapLoginRoleToUserRole(
  role: LoginRoleOption,
): "OWNER_ADMIN" | "CASHIER" | "TECHNICIAN" {
...
export function EditWorkerModal({
  ...
  const [value, setValue] = React.useState<EditWorkerForm>(
    buildInitial(worker),
  );
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl w-[min(94vw,36rem)] max-h-[90vh] p-0 overflow-hidden rounded-3xl">
        <div className="flex max-h-[90vh] flex-col">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto p-6 space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label>
                  {language === "uz" ? "Ish toifasi" : "Job Category"}
                </Label>
                <Select
                  value={value.jobCategory || undefined}
                  onValueChange={(v) =>
                    setValue((p) => ({ ...p, jobCategory: v as JobCategory }))
                  }
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="CASHIER">
                      {language === "uz" ? "Kassir" : "Cashier"}
                    </SelectItem>
                    <SelectItem value="TECHNICIAN">
                      {language === "uz" ? "Texnik" : "Technician"}
                    </SelectItem>
                    <SelectItem value="CLEANER">
                      {language === "uz" ? "Tozalovchi" : "Cleaner"}
                    </SelectItem>
                    <SelectItem value="ACCOUNTANT">
                      {language === "uz" ? "Buxgalter" : "Accountant"}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2">
                <Label>
                  {language === "uz" ? "Oylik ish haqi" : "Monthly Salary"}
                </Label>
                <Input
                  className="h-10 rounded-2xl"
                  inputMode="numeric"
              ...
              <div className="space-y-2">
                <Label>
                  {language === "uz" ? "Telefon raqami" : "Phone Number"}
                </Label>
                <Input
                  className="h-10 rounded-2xl"
                  value={value.phoneNumber}
                  onChange={(e) =>
                    setValue((p) => ({ ...p, phoneNumber: e.target.value }))
                  }
                />
              </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setValue((p) => ({
                          ...p,
                          loginRole: v as LoginRoleOption,
                        }))
                      }
                    >
                      <SelectTrigger className="h-10 rounded-2xl">
          ...
          <div className="border-t p-4">
            <div className="flex flex-wrap justify-end gap-2">
              ...
              <Button
                className="rounded-2xl"
                disabled={!baseValid || !loginValid || saving}
                onClick={handleSave}
              >
